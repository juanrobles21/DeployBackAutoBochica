...
class CourseControllerUpdate extends UpdateDAO_1.default {
    updateCourse(req, res) {
        ...
        const time_course = req.body.timeCourse;
        const price = req.body.price;
        const parameter = [id_course, type_course, time_course, price];
        CourseControllerUpdate.updateCourse(sql_update_1.SQL_COURSE_UPDATE.UPDATE, parameter, res);
    }
}
