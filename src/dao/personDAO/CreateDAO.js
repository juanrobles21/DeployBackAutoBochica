        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield connectionDB_1.default
                ...
                if (answer.id_person != 0) {
                    res.status(200).json({ answer: 'Person created', newCode: answer.id_person });
                }
                else {
                    res.status(402).json({ answer: 'Error, numero de cedula de la person ya Esta creado', newCode: answer.id_person });
                }
            })
                .catch((miError) => {
