...
class CoursesCreate {
    static createCourse(sqlCreate, parameter, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield connectionDB_1.default.task((consult) => __awaiter(this, void 0, void 0, function* () {
                ...
                .then((response) => {
                if ((response === null || response === void 0 ? void 0 : response.id_course) != 0) {
                    res.status(200).json({ answer: 'Courses', newCode: response === null || response === void 0 ? void 0 : response.id_course });
                }
                else {
                ...
                res.status(400).json({ answer: 'Error al crear la otra informacion del curso.' });
            });
        });
    }
}
