...
class Server {
    ...
    activeRoute() {
        ...
        this.app.use('/api/private/course', CourseRoute_1.default);
        this.app.use('/api/private/roles', RoleRoute_1.default);
        ...
        this.app.use('/api/private/vehicle', VehicleRoute_1.default);
    }
    start() {
